# sgx-arweave-client-js

![img](doc/logo.png)

**sgx-arweave-client-js** is a demo to give a verification of TEE report from the result generated by [sgx-arweave-cpp](https://github.com/Safeheron/sgx-arweave-cpp).
...
## Input File
[data.json](https://github.com/Safeheron/sgx-arweave-client-js/blob/main/data.json) is the input file that contains:
